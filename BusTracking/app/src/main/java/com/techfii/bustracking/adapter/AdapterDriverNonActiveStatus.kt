...
import com.techfii.bustracking.databinding.LayoutNonActiveBusBinding
import com.techfii.bustracking.models.DriverStatusData

class AdapterDriverNonActiveStatus  : RecyclerView.Adapter<AdapterDriverNonActiveStatus.ViewHolder>(){
    ...
    inner class ViewHolder(val binding: LayoutNonActiveBusBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            LayoutNonActiveBusBinding.inflate(
